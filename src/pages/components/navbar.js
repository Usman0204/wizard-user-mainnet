            ...
            <div className="navlinks">
              ...
              <Dropdown align='end'>
                ...
                <Dropdown.Menu>
                  ...
                  <h6 className="inner-style-heading">Creator Dashboard</h6>
                  {/* <Link href="/launchpad" className="dropitem">Launchpad</Link> */}
                  <Link href="https://creator.wizardgallery.xyz/" target='_blank' className="dropitem marginleft" >Apply For launchpad</Link>
      ...
      <Offcanvas show={show1} onHide={handleClose1} placement='end' className="mblnavside">
        ...
        <Offcanvas.Body>
          <div className="mblnavlinks">
            ...
            <Link href="/discovercollection" className="dropitemmbl">Discover</Link>
            <Link href="/launchpad" className="dropitemmbl">Launchpad</Link>
            <Link href="/launchpad?tab=edition" className="dropitemmbl">Open Editions</Link>
            <h6 className="inner-style-heading">Creator Dashboard</h6>
