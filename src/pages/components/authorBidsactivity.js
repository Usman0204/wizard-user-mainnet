...
const AuthorBidsActivity = () => {
    ...
    const getNftActivityDetails = async () => {
        ...
        config = {
            method: "get",
            url: `${api_url}/users/nfts-bid?offset=1&limit=20`,
            headers: {
        ...
        axios(config)
            .then(function (response) {
                setdataset3(response?.data?.data?.userBids)
                            ...
                            <div key={item.nftId}>
                                        <div className="single-item" >
                                            ...
                                            <div className="right-content">
                                                ...
                                                <h6>
                                                    <span className='text-span-color'> Bid Price  {' '}
                                                        <span className='text-light'>{item?.bidPrice}</span>  Core
                                                    </span>
                                                </h6>
...
export default AuthorBidsActivity;
