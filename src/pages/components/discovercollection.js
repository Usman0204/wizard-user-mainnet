      ...
      <section className="discovercollectionmain">
        ...
        <div className="discovercollectioncontainer">
          ...
          <div className="dicovercollectionupper">
            ...
            <div className="searchcollectionmain">
              <input
                ...
                className="searchcollectioninput"
              />
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className="searchcollectionimg"
              >
                <path
                  d="M9.58366 18.1251C4.87533 18.1251 1.04199 14.2917 1.04199 9.58342C1.04199 4.87508 4.87533 1.04175 9.58366 1.04175C14.292 1.04175 18.1253 4.87508 18.1253 9.58342C18.1253 14.2917 14.292 18.1251 9.58366 18.1251ZM9.58366 2.29175C5.55866 2.29175 2.29199 5.56675 2.29199 9.58342C2.29199 13.6001 5.55866 16.8751 9.58366 16.8751C13.6087 16.8751 16.8753 13.6001 16.8753 9.58342C16.8753 5.56675 13.6087 2.29175 9.58366 2.29175Z"
                  fill="#745F8C"
                />
                <path
            ...
            <div className="dicovercollectionuppermbl d-none">
              <div className="dicovercollectionbtns">
                <button className="filterbtnmbl" onClick={handleShow}>
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="filterimginner"
                  >
                    <path
                      d="M23.4351 8.04373H17.1742C16.7464 8.04373 16.3916 7.68895 16.3916 7.26112C16.3916 6.8333 16.7464 6.47852 17.1742 6.47852H23.4351C23.8629 6.47852 24.2177 6.8333 24.2177 7.26112C24.2177 7.68895 23.8629 8.04373 23.4351 8.04373Z"
                      fill="white"
                    />
                    <path
                      d="M6.73973 8.04373H2.56581C2.13799 8.04373 1.7832 7.68895 1.7832 7.26112C1.7832 6.8333 2.13799 6.47852 2.56581 6.47852H6.73973C7.16755 6.47852 7.52233 6.8333 7.52233 7.26112C7.52233 7.68895 7.16755 8.04373 6.73973 8.04373Z"
                      fill="white"
                    />
                    <path
                      d="M10.9133 11.6957C8.47156 11.6957 6.47852 9.70269 6.47852 7.26095C6.47852 4.81922 8.47156 2.82617 10.9133 2.82617C13.355 2.82617 15.3481 4.81922 15.3481 7.26095C15.3481 9.70269 13.355 11.6957 10.9133 11.6957ZM10.9133 4.39139C9.32721 4.39139 8.04373 5.67487 8.04373 7.26095C8.04373 8.84704 9.32721 10.1305 10.9133 10.1305C12.4994 10.1305 13.7829 8.84704 13.7829 7.26095C13.7829 5.67487 12.4994 4.39139 10.9133 4.39139Z"
                      fill="white"
                    />
                    <path
                      d="M23.435 19.5222H19.2611C18.8333 19.5222 18.4785 19.1675 18.4785 18.7396C18.4785 18.3118 18.8333 17.957 19.2611 17.957H23.435C23.8629 17.957 24.2176 18.3118 24.2176 18.7396C24.2176 19.1675 23.8629 19.5222 23.435 19.5222Z"
                      fill="white"
                    />
                    <path
                      d="M8.82668 19.5222H2.56581C2.13799 19.5222 1.7832 19.1675 1.7832 18.7396C1.7832 18.3118 2.13799 17.957 2.56581 17.957H8.82668C9.25451 17.957 9.60929 18.3118 9.60929 18.7396C9.60929 19.1675 9.25451 19.5222 8.82668 19.5222Z"
                      fill="white"
                    />
                    <path
                      d="M15.0871 23.1743C12.6454 23.1743 10.6523 21.1812 10.6523 18.7395C10.6523 16.2977 12.6454 14.3047 15.0871 14.3047C17.5289 14.3047 19.5219 16.2977 19.5219 18.7395C19.5219 21.1812 17.5289 23.1743 15.0871 23.1743ZM15.0871 15.8699C13.501 15.8699 12.2176 17.1534 12.2176 18.7395C12.2176 20.3256 13.501 21.609 15.0871 21.609C16.6732 21.609 17.9567 20.3256 17.9567 18.7395C17.9567 17.1534 16.6732 15.8699 15.0871 15.8699Z"
                  ...
                  >
                    <g id="vuesax/outline/search-normal">
                      <g id="search-normal">
                        <path
                          id="Vector"
                          d="M9.58366 18.1253C4.87533 18.1253 1.04199 14.292 1.04199 9.58366C1.04199 4.87533 4.87533 1.04199 9.58366 1.04199C14.292 1.04199 18.1253 4.87533 18.1253 9.58366C18.1253 14.292 14.292 18.1253 9.58366 18.1253ZM9.58366 2.29199C5.55866 2.29199 2.29199 5.56699 2.29199 9.58366C2.29199 13.6003 5.55866 16.8753 9.58366 16.8753C13.6087 16.8753 16.8753 13.6003 16.8753 9.58366C16.8753 5.56699 13.6087 2.29199 9.58366 2.29199Z"
                          fill="#555357"
                        />
                        <path
                          id="Vector_2"
              ...
              <button className="lastbtn">
                ...
                <div className="arrowimages">
                  ...
                  >
                    <path
                      d="M1.62263 6L6.62705 6L11.1334 6C11.9046 6 12.2902 5.13 11.7439 4.62L7.58295 0.735C6.91623 0.112499 5.83181 0.112499 5.16509 0.735L3.58263 2.2125L1.0041 4.62C0.465904 5.13 0.851479 6 1.62263 6Z"
                      fill="#745F8C"
                    />
                  </svg>
                  <svg
                  ...
                  >
                    <path
                      d="M11.1313 0H6.12685H1.62046C0.849313 0 0.463739 0.87 1.00997 1.38L5.17095 5.265C5.83767 5.8875 6.9221 5.8875 7.58882 5.265L9.17128 3.7875L11.7498 1.38C12.288 0.87 11.9024 0 11.1313 0Z"
                      fill="#745F8C"
                    />
                  </svg>
                </div>
              ...
              <div className="searchingmain">
                ...
                >
                  ...
                  >
                    ...
                    <path
                      d="M12.0418 19.9598L19.9614 12.0402M19.9614 19.9598L12.0418 12.0402"
                      stroke="white"
                      stroke-width="2"
          ...
          <div
            className={
              toggle
                ? "dicovercollectionlower"
                : "dicovercollectionlower forgap"
            }
          >
            ...
            <div
              className={
                toggle
                  ? "maindicovercollectiontable"
                  : "maindicovercollectiontable widthset"
              }
            >
                    ...
                    <tr>
                      ...
                      <th>
                        <div className="theadmain">
                          <p className="theadpara">Volume</p>
                  ...
                  <tbody>
                    {discover?.map((item, index) => {
                      ...
                      const percentageChange =
                        volumeYesterday !== 0
                          ? ((item.volumeToday - volumeYesterday) /
                              volumeYesterday) *
                            100
                          : 0;
                      const percentageChangeOfFloor =
                        floorYesterday !== 0
                          ? ((item?.floorToday?.price - floorYesterday) /
                              floorYesterday) *
                            100
                          : 0;
                      ...
                      const className =
                        percentageChange < 0 ? "redtext" : "redtext text-light";
                      const classNameFloor =
                        percentageChangeOfFloor < 0
                          ? "redtext"
                          : "redtext text-light";

                      // Ensure the display of percentage changes does not show NaN or infinity
                      const displayPercentageChange = isFinite(percentageChange)
                        ? percentageChange.toFixed(2) + "%"
                        : "0%";
                      const displayPercentageChangeOfFloor = isFinite(
                        percentageChangeOfFloor
                      )
                        ? percentageChangeOfFloor.toFixed(2) + "%"
                        : "0%";
                      const result = parseFloat(item?.marketCap * 0.99);
                      return (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>
                            ...
                            >
                              <div className="maincollectiontd">
                                <div className="collectiontdimg">
                                  <img
                                    src={item?.imageUrl}
                                    alt="collectiontdinnerimg"
                                    className="collectiontdinnerimg"
                                  />
                                </div>
                                <p className="collectiontdpara no-underline">
                                  {item?.name}
                                </p>
                              </div>
                            </Link>
                          ...
                          <td>
                            <p className={className}>
                              {parseFloat(displayPercentageChange)?.toFixed(2)}{" "}
                              %
                            </p>
                          </td>
